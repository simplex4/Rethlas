...
9. Persist each checked item to `statement_checks` using `python3 research.py append --channel statement_checks --file record.json`.
...
<!-- Adapted from agents/verification/.agents/skills/verify-sequential-statements/SKILL.md; preserve the repository license and NOTICE. -->
