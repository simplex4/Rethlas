...
6. If a conclusion is fragile, record why it is fragile and indicate that `skills/construct-counterexamples.md` should be considered next.
...
<!-- Adapted from agents/generation/.agents/skills/obtain-immediate-conclusions/SKILL.md; preserve the repository license and NOTICE. -->
